...
public class SandboxListas
{
    ...
    public void insertarEntero(int entero, int posicion) {
        listaEnteros.add(Math.min(Math.max(posicion, 0), listaEnteros.size()), entero);
    }
    /**
    ...
    public void volverPositivos() {
        listaEnteros.replaceAll(Math::abs);
    }
    ...
    public int contarApariciones(int valor) {
        return (int) listaEnteros.stream().filter(num -> num == valor).count();
    }
    ...
    public int contarApariciones(String cadena) {
        return (int) listaCadenas.stream().filter(str -> str.equalsIgnoreCase(cadena)).count();
    }
    ...
    public int contarEnterosRepetidos() {
        ...
        listaEnteros.forEach(num -> frecuencia.put(num, frecuencia.getOrDefault(num, 0L) + 1));
    ...
    public boolean compararArregloEnteros(int[] otroArreglo) {
        return Arrays.equals(listaEnteros.stream().mapToInt(Integer::intValue).toArray(), otroArreglo);
    }
