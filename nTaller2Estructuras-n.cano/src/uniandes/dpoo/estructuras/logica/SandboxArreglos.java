...
public class SandboxArreglos
{
    ...
    public void eliminarCadena(String cadena) {
        arregloCadenas = Arrays.stream(arregloCadenas).filter(str -> !str.equals(cadena)).toArray(String[]::new);
    }
    ...
    public void volverPositivos() {
        arregloEnteros = Arrays.stream(arregloEnteros).map(Math::abs).toArray();
    }
    ...
    public int[] calcularRangoEnteros() {
        ...
        return new int[]{Arrays.stream(arregloEnteros).min().orElse(0), Arrays.stream(arregloEnteros).max().orElse(0)};
    }
   ...
   public boolean mismosEnteros(int[] otroArreglo) {
        return Arrays.stream(arregloEnteros).sorted().toArray().equals(Arrays.stream(otroArreglo).sorted().toArray());
    }
